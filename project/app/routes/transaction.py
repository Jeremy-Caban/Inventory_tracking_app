...
@app.route('/incoming/<int:incid>', methods=['GET','PUT','DELETE']) 
...
@app.route('/outgoing/<int:outid>', methods=['GET','PUT','DELETE']) 
...
@app.route('/exchange/<int:tranid>', methods=['GET','PUT','DELETE']) 
