...
a.post(p, json = {"pprice":250, "ptype":"Plastic", "pname":"Cupboard"}) #4
a.post(p, json = {"pprice":500, "ptype":"Wood", "pname":"Door"}) #5
a.post(p, json = {"pprice":775, "ptype":"Wood", "pname":"Sculpture"}) #6
a.post(p, json = {"pprice":35, "ptype":"Plastic", "pname":"Bottle"}) #7
a.post(p, json = {"pprice":385, "ptype":"PVC", "pname":"Kiddie Pool"}) #8
a.post(p, json = {"pprice":75, "ptype":"Wood", "pname":"Table"}) #9
#Supplier Creation------------------------------------------------------
#Supp 1
...
a.post(w, json ={"wname":"Transaction_Warehouse", "wcity":"Aguada", "wemail":"db@lol", "wphone":"787-1DB-TEST", "budget":500}) #1
a.post(w, json ={"wname":"big balling warehouse", "wcity":"Aguada", "wemail":"db@test", "wphone":"787-2DB-TEST", "budget":10000}) #2
a.post(w, json ={"wname":"small balling warehouse", "wcity":"San Juan", "wemail":"db@yolo", "wphone":"787-3DB-TEST", "budget":500}) #3
a.post(w, json ={"wname":"bobs warehouse", "wcity":"Mayaguez", "wemail":"db@gmail", "wphone":"787-4DB-TEST", "budget":100}) #4
a.post(w, json ={"wname":"Database Warehouse", "wcity":"Caguas", "wemail":"db@hotmail", "wphone":"787-5DB-TEST", "budget":500}) #5
a.post(w, json ={"wname":"Jeremy Warehouse", "wcity":"Aguada", "wemail":"db@Jeremy", "wphone":"787-6DB-TEST", "budget":10000}) #6
a.post(w, json ={"wname":"Sebastian warehouse", "wcity":"Moca", "wemail":"db@Sebastian", "wphone":"787-7DB-TEST", "budget":500}) #7
